  ...
  return (
    <div className="min-h-screen bg-[#f3e8ff] px-6 py-16">
      <div className="mx-auto w-full max-w-2xl">
        <h1 className="font-display text-5xl font-black tracking-tight text-[#4c1d95]">Riley Young</h1>
        <p className="mt-4 text-base font-semibold text-[#6b21a8]">
          me + lovable + windsurf
        </p>

        <div className="mt-10 rounded-xl border border-border bg-card p-6 shadow-card">
          <h2 className="font-display text-2xl font-bold text-white">Party4U</h2>
        ...
        <div className="mt-6 rounded-xl border border-border bg-card p-6 shadow-card">
          <h2 className="font-display text-2xl font-bold text-white">Revenue Tracker</h2>
          <p className="mt-2 text-sm text-white/80">
        ...
        <div className="mt-6 rounded-xl border border-border bg-card p-6 shadow-card">
          <h2 className="font-display text-2xl font-bold text-white">Pitch Deck AI</h2>
          <p className="mt-2 text-sm text-white/80">
