      ...
      <div className="mx-auto w-full max-w-4xl">
        ...
        <div className="flex items-center justify-between gap-4">
          <div>
            ...
            <p className="mt-1 text-sm text-muted-foreground">Live subscription metrics</p>
          </div>
          <Link
            to="/"
              ...
              return (
                <div key={plan.name} className="space-y-1">
                  <div className="flex items-center justify-between text-sm">
                    ...
                    <span className="text-muted-foreground">{formatCurrency(plan.amount)}/mo</span>
                  </div>
          ...
          {ticker.length === 0 ? (
            ...
            <div className="space-y-2 max-h-[400px] overflow-y-auto">
              {ticker.map((entry) => (
                <div
                  key={entry.id}
                  className="flex items-center justify-between rounded-lg border border-border/50 bg-secondary/30 px-4 py-2.5 animate-fade-in"
                >
                  <div className="flex items-center gap-3 min-w-0">
                    ...
                    <div className="min-w-0">
                      ...
                      <p className="text-xs text-muted-foreground">
                        subscribed to <span className="font-semibold text-primary">{entry.plan}</span>
                      </p>
                    </div>
                  </div>
